...
:- pce_global(@graph_link, new(link(link, link, line(0,0,0,0,none)))).
...
initialise(Node, Name:name) :->
    ...
    send(Node, display, circle(45), point(-2, -2)),
...
make_graph_node_recogniser(R) :-
    ...
    send(R, condition,
         ?(@event?position, distance, point(0,0)) < 15).
...
:- graph_viewer.
    ...
    test(1,1). test(1,2). test(1,3). test(1,4). test(1,5). test(1,6). test(1,7). test(1,8). test(1,9). test(1,10). test(2,1). test(2,2). test(2,3). test(2,4). test(2,5). test(2,6). test(2,7). test(2,8). test(2,9). test(2,10). test(3,1). test(3,2). test(3,3). test(3,4). test(3,5). test(3,6). test(3,7). test(3,8). test(3,9). test(3,10). test(4,1). test(4,2). test(4,3). test(4,4). test(4,5). test(4,6). test(4,7). test(4,8). test(4,9). test(4,10). test(5,1). test(5,2). test(5,3). test(5,4). test(5,5). test(5,6). test(5,7). test(5,8). test(5,9). test(5,10). test(6,1). test(6,2). test(6,3). test(6,4). test(6,5). test(6,6). test(6,7). test(6,8). test(6,9). test(6,10). test(7,1). test(7,2). test(7,3). test(7,4). test(7,5). test(7,6). test(7,7). test(7,8). test(7,9). test(7,10). test(8,1). test(8,2). test(8,3). test(8,4). test(8,5). test(8,6). test(8,7). test(8,8). test(8,9). test(8,10). test(9,1). test(9,2). test(9,3). test(9,4). test(9,5). test(9,6). test(9,7). test(9,8). test(9,9). test(9,10). test(10,1). test(10,2). test(10,3). test(10,4). test(10,5). test(10,6). test(10,7). test(10,8). test(10,9). test(10,10).
